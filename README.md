...
HalfLife isn't just a counter; it’s a predictive tool designed to bridge the gap between your espresso machine and your nervous system. By modeling caffeine pharmacokinetics (PK) directly on your wrist, HalfLife helps you master alertness without sacrificing sleep.

**Disclaimer: HalfLife is a mathematical model for informational purposes and is not medical advice.**

## The Philosophy

Most trackers treat caffeine like a simple tally. HalfLife treats it like a drug. It simulates the journey from the first sip to the final metabolic clearance, even accounting for absorption lag.
...
Focus: PK Metabolic Modeling & Data Ingestion
  ...
  [x] Sleep-Gap Analysis: Calculation of "Deep Sleep Readiness" (Time to <50mg).

  [-] (partial) Daily Limits: Warnings when exceeding set doses per day.
...
HalfLife currently utilizes a One-Compartment Pharmacokinetic Model. While generic trackers assume instant absorption, HalfLife models the reality of your biology:
  ...
  Why this matters: Depending on gastric load (if you've eaten) and genetics, the "peak" of your coffee might hit at 30 minutes or 90 minutes. HalfLife aims to help you predict that peak so you don't over-stack your doses.
